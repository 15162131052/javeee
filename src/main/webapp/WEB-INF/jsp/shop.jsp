      ...
      <ul>
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="LXSB">联想亲民鼠标</a></li>
                    <li><a href="LXSB">联想商务鼠标</a></li>
                    <li><a href="LXSB">联想高端鼠标</a></li>
                </ul>
            </li>
            <hr>
            <li class="dropdown">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="LJSB">罗技低端区</a></li>
                    <li><a href="LJSB">罗技中端区</a></li>
                    <li><a href="LJSB">罗技高端区</a></li>
                </ul>
            </li>
            <hr>
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="SRSB">赛锐标准区</a></li>
                    <li><a href="SRSB">赛锐尖刀区</a></li>
                    <li><a href="SRSB">赛锐大王区</a></li>
                </ul>
            </li>
         </ul>
   </div>
