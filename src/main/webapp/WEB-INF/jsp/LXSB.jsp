...
<div class="container">
 ...
 <div class="container">
      ...
      <ul>
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="LXSB">联想商务区</a></li>
                    <li><a href="LXSB">联想高端区</a></li>
                </ul>
            </li>
            <hr>
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="sweater">雷蛇毒蛇区</a></li>
                    <li><a href="sweater">雷蛇霸王区</a></li>
                </ul>
            </li>
            <hr>
            <li class="dropdown">
   ...
   <div class="col-md-10">
    <div class="container">
       <c:forEach items="${requestScope.LXSB_list }" var="t">
